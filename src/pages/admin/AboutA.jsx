    ...
    return(
        <div>
            ...
            <div className="pt-16 pb-8 pl-[17rem] pr-7">
                <p className="text-lg font-medium">Konten Tentang Kami :</p>
                <button className="bg-[#7BAD86] text-white mt-5 px-4 py-1 rounded-md"><a href="/formAbout">Tambah Data</a></button>
